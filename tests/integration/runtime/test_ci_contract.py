"""CI contract test asserting the v0.12.1 stabilization CI gates.
...
class TestCIWorkflowContract:
    """Static contract over ``.github/workflows/ci.yml`` for v0.12.1.
    ...
    def test_ci_checks_lk_version_reports_release(self) -> None:
        ...
        grepping for ``0.12.1``. This is the S2 version-convergence gate:
