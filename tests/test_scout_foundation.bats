...
@test "SCOUT-COMMIT-FOUNDATION: no markdown files warns and exits nonzero because git commit has nothing" {
    run $PY scout commit-foundation --spec-id nothing --message "x" --version v0.6 --no-push
    [ "$status" -ne 0 ]
