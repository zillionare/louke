...
@test "PROBE-FORM-001: Probe 引用 gh issue list 拉取 issue" {
...
@test "PROBE-FORM-002: Probe 引用 issue form 字段(需求 ID / Spec 链接 / 验收标准)" {
...
@test "PROBE-FORM-003: Probe 复用 verify_issue_schema 的解析逻辑" {
...
@test "PROBE-FORM-004: Probe 命名 UT-{issue#}-{AC序}-{测试序}" {
...
@test "PROBE-FORM-005: Probe 文档把 spec.md 标为背景参考,而非解析源" {
...
@test "PROBE-FORM-006: Probe 退出条件提到每条 AC 都要 UT 覆盖" {
...
@test "PROBE-FORM-007: Probe 反模式禁止重新解析 spec.md" {
