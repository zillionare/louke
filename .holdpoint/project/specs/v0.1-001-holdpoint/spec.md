# holdpoint v0.1 — Framework Init Spec

- **Spec ID**: v0.1-001-holdpoint
- **目的**: holdpoint 框架的初始化 spec；作为 verify_issue_schema 的 fixture
- **状态**: fixture（仅供 bats 测试使用，不进入真实工作流）

## 功能需求

<a id="fr-001"></a>
**FR-001**: holdpoint 框架定义 12 个专业 agent
