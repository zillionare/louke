"""Failure recovery, cancellation, resource cleanup and archive guard (FR-2001).

This module handles runtime failures, run cancellation, cleanup of managed
resources and read-only archive guards. It is separate from ``recovery.py``,
which deals with crash recovery of uncertain WorkflowRun state.
"""
