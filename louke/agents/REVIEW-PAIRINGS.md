...
本文档定义 louke 中各 Agent 的评审配对关系。Maestro 阶段推进的"评审"步骤按此执行。

> **louke 是什么**：一套规格先行、测试驱动、工具对齐 Agent 行为的多 Agent 协作开发方法。
...
- 评审范围：`.louke/project/specs/{spec-id}/test-plan.md`
...
- 评审范围：`.louke/project/specs/{spec-id}/architecture.md` + `interfaces.md`
